...
# load the dataset
data_full = pd.read_csv(r'ITA_covid_model_1.csv')
...
new_1 = [2129376, 22210, 2553,	25375,	157524,	26756131,	8.4]
new_2 = [2141201,	11825,	2569,	25517,	67174,	26823305,	8.2]
new_3 = [2155446,	14245,	2583,	25658,	102974,	26926279,	8.2]
new_4 = [2166244,	10798,	2579,	25896,	77993,	27004272,	8.1]
new_5 = [2181619,	15375,	2569,	25964,	135106,	27139378,	7.8]
new_6 = [2201945,	20326,	2571,	25745,	178596,	27317974,	7.7]
new_7 = [2220361,	18416,	2587,	25878,	121275,	27439249,	7.4]
# make a prediction
