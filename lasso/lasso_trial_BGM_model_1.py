...
# load the dataset
data_full = pd.read_csv(r'BGM_covid_model_1.csv')
...
new_1 = [648289,	1793,	489,	2081,	11933,	6976500,	13.7]
new_2 = [649169,	880,	481,	2122,	18577,	6995077,	13.9]
new_3 = [650011,	842,	468,	2185,	17637,	7012714,	14.1]
new_4 = [650887,	876,	464,	2226,	40229,	7052943,	14.9]
new_5 = [652735,	1848,	430,	2130,	60064,	7113007,	16.1]
new_6 = [655732,	2997,	404,	2076,	55217,	7168224,	16.9]
new_7 = [658655,	2923,	381,	2018,	44353,	7212577,	17.5]
# make a prediction
