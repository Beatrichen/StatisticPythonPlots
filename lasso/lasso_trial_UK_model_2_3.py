...
# load the dataset
data_full = pd.read_csv(r'UK_covid_model_3.csv')
...
new_1 = [18668,	3726,	32945,	643204, 27.5]
new_2 = [16906,	3638,	31750,	606382,	28.1]
new_3 = [19215,	3628,	30584,	801949,	29.5]
new_4 = [20734,	3572,	29388,	783851,	31.3]
new_5 = [19204,	3505,	28352,	671585,	33.6]
new_6 = [18363,	3373,	26880,	454008,	35]
new_7 = [15904,	3302,	26765,	584933,	36.5]
# make a prediction
